...
---@field dark_background_icon? string
...
---@field icon_tintable_mask? string
---@field icon_tintables? IconData
---@field icon_tintable? string
...
---@field icon_color_indicator_masks? IconData
---@field icon_color_indicator_mask? string
---@field icon_size? uint8
